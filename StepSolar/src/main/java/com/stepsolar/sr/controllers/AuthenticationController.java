...
import com.stepsolar.sr.dto.LoginResponseDto;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(
        ...
        User authenticationUser = userService.findByEmail(authenticationRequest.getUsername());
        ...
        String jws = tokenHelper.generateToken(user.getUsername(), user.getId(), device);
        int expiresIn = tokenHelper.getExpiredIn(device);
        User getUser = userService.findByEmail(authenticationRequest.getUsername());
        // Add cookie to response
        response.addCookie(createAuthCookie(jws, expiresIn));
        // Return the token
        return ResponseEntity.ok(new LoginResponseDto(jws, getUser));
    }

    @ApiOperation(value = "Update Token", notes = "Update Token")
    @ApiImplicitParams({
        @ApiImplicitParam(name = "access_token", value = "token",
