...
public class DateFormatProvider {
	...
	public static String converTimeRange(Date start, Date end, ZoneId zoneId) {
		...
		LocalDateTime startDate = start.toInstant().atZone(zoneId != null ? zoneId : ZoneId.systemDefault())
				.toLocalDateTime();
		LocalDateTime endDate = end.toInstant().atZone(zoneId != null ? zoneId : ZoneId.systemDefault())
				.toLocalDateTime();
