...
public class BcryptHashGenerator {
    ...
    private static final Logger log = LoggerFactory.getLogger(BcryptHashGenerator.class);
     ...
     *
     * @param password_plaintext The user's plaintext password, as provided
     * during a login request
     * @param stored_hash The user's stored password hash, retrieved from the
